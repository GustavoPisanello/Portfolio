        ...
        <>
            <div className="flex w-full h-full relative">
                ...
                <div className="w-full lg:w-1/2 h-full flex flex-col items-center gap-y-4">
                    ...
                    <form onSubmit={handleSubmit} className="w-[85%] flex flex-col gap-y-2 h-full max-w-[455px] items-center justify-center" action="">
                    <div className="w-full flex justify-center">
                        ...
                        <div className="h-1/2 w-full lg:h-fit flex flex-col gap-y-2 ">
                            <div className="flex flex-col">
                                ...
                                <input onChange={handleInputChange} value={contactData.name} className="text-primary_color px-2 font-[Fredoka] border border-primary_color bg-transparent h-8" type="text" name="name" id="name" />
                            </div>
                            <div className="flex flex-col">
                                <label htmlFor="email" className="font-[JockeyOne] text-primary_color">EMAIL</label>
                                <input onChange={handleInputChange} value={contactData.email} className="text-primary_color px-2 font-[Fredoka] border border-primary_color bg-transparent h-8" type="text" name="email" id="email" />
                            </div>
                            <div className="flex flex-col">
                                <label htmlFor="subject" className="font-[JockeyOne] text-primary_color">SUBJECT</label>
                                <input onChange={handleInputChange} value={contactData.subject} className="text-primary_color px-2 font-[Fredoka] border border-primary_color bg-transparent h-8" type="text" name="subject" id="subject" />
                            </div>
                        </div>
                        ...
                        <div className="h-1/2 lg:h-fit w-full flex flex-col gap-y-6">
                            <div className="flex flex-col w-full">
                                ...
                                <textarea onChange={handleInputChange} value={contactData.message} name="message" className="resize-none lg:border-primary_color lg:border text-primary_color font-[Fredoka] h-28 p-2 bg-secondary_color"/>
                            </div>
                            <button className="text-primary_color lg:border lg:border-primary_color bg-secondary_color px-5 py-2 rounded-full font-[JockeyOne] text-xl" type="submit">SUBMIT</button>
                        </div>
                    </form>
                </div>
            </div>
